  ...
  return (
    <section className="mt-34 mb-28 flex flex-col gap-8 md:flex-row">
      ...
      <div data-aos="fade-up" className="max-w-[570px]">
        <figure>
          <div className="relative min-h-[338px] mb-3 border-50 border-[#e5cbad] md:border-100 md:basis-1/2 md:min-h-[470px]">
        ...
        <p className="text-2xl leading-[1.3] my-18">
          ...
          find hidden courtyards and locals chatting over coffee. Skip the fancy
          restaurants and enjoy today&apos;s catch at a family-run taverna.
          Catch the sunset for a moment of peace. And, if you can, strike up a
          conversation with a local - they&apos;ll tell you stories of Oia that
          no guidebook can.
        </p>
      </div>
    </section>
