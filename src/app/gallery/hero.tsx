...
export const Hero = () => {
  return (
    <header>
      <h1 className="text-[3.5rem] mt-48 ml-10 mb-2 md:text-[5rem]">Gallery</h1>
      ...
      <div className="relative w-full h-[606px] before:absolute before:top-0 before:left-0 before:w-full before:h-full before:bg-black/75 before:z-10">
        ...
        <div className="text-white w-full p-20 text-center z-20 absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
